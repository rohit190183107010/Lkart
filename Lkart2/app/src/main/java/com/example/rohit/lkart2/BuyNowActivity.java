...
import com.example.rohit.lkart2.HomePageActivity;
...
public class BuyNowActivity extends AppCompatActivity {
    ...
    String email;
    String contact;
    String total="0",qty = "0",maintotal ="0",productid = "";
...
//        contact=getIntent().getStringExtra("contact");
        ...
        maintotal = String.valueOf(Float.parseFloat(total) * Integer.parseInt(qty));


        Toast.makeText(BuyNowActivity.this, "Total : " + maintotal, Toast.LENGTH_SHORT).show();
        txttotalpayment.setText(maintotal);
...
//        txtmobile.setText(contact);
        ...
        btnplaceorder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    dialog.show();
                    StringRequest str=new StringRequest(Request.Method.POST, WebServices.LOAD_BUYNOW, new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
                            Toast.makeText(BuyNowActivity.this, "Successfully done", Toast.LENGTH_SHORT).show();

                            dialog.dismiss();
                            Intent i=new Intent(BuyNowActivity.this,HomePageActivity.class);
                            startActivity(i);
                        ...
                        public void onErrorResponse(VolleyError error) {
                            dialog.dismiss();
                            Toast.makeText(BuyNowActivity.this, "server "+error.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }){
                        @Override
                        protected Map<String, String> getParams() throws AuthFailureError {
                            ...
                            params.put("total_payment",maintotal);
                            params.put("qty",qty);
                    ...
                    RequestQueue q= Volley.newRequestQueue(BuyNowActivity.this);
                    q.add(str);
                }
        ...
        StringRequest str=new StringRequest(Request.Method.POST,WebServices.LOAD_USER, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(BuyNowActivity.this, "Exception " + e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        }, new Response.ErrorListener() {
            @Override
        ...
        StringRequest jsonObjectRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (jsonObject.has(SdkConstants.STATUS)) {
                        ...
                        if (status != null || status.equals("1")) {
                            ...
                            PayUmoneySdkInitilizer.startPaymentActivityForResult(BuyNowActivity.this, paymentParam);
                        } else {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof NoConnectionError) {
                    Toast.makeText(BuyNowActivity.this,
                            BuyNowActivity.this.getString(R.string.connect_to_internet),
                            Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(BuyNowActivity.this,
                            error.getMessage(),
